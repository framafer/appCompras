...
export class EditpresComponent {
  ...
  presupuesto: Presupuesto = {"id$" : "","base": 0, "concepto": "", "fecha": "", "iva": 0, "proveedor": "", "tipo": 0, "total": 0};
  /* presupuestoG!: { id$: string; presupuesto: Presupuesto; };
 */
      ...
      .subscribe( parametros => {
        ...
        this.presupuestoService.getPresupuesto(this.id$)
          .subscribe( presupuesto => {
            ...
            this.presupuesto = JSON.parse(JSON.stringify(presupuesto));
            this.presupuesto.id$ = this.id$;
          });
        })
